...
class MyVk_Api(vk_api):
    ...
    def find_people(self):
        ...
        MyVk_Api.users_find_list = users_list['items']
    ...
    def check_user(self, user):
        ...
        '''
        if user['id'] not in MyVk_Api.already_seen_users:
            if not user['is_closed']:
                return True
            else:
                MyVk_Api.already_seen_users.append(user['id'])

    def get_users_info(self) -> list:
        self.find_people()
        if MyVk_Api.users_find_list:
            users_info_for_print = []
            for user in MyVk_Api.users_find_list:
                ...
                MyVk_Api.already_seen_users.append(user_id)
